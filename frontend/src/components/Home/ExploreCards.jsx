...
const ExploreCards = ({ course, active }) => {
    return (
        <div className={`flex flex-col h-[17rem] cursor-pointer justify-between transition-all duration-300 ${active === true ? "bg-white text-black explore-more-card-shadow" : "bg-[#161D29]"}`}>
            <div className={`p-4`}>
